 ...
 * );
 * // Or more simply...
 * var json = require('houston_ruleset_parser').parse(
 *     'exampleEvent { ExampleModule.exampleMethod; }'
 * );
 *
 * // In browser land...
...
;(function() {
    ...
    var global;
    // the HoustonRulesetParser object
    ...
    /*                           *\
    | HoustonRulesetParser object |
    \*                           */

    /**
     * the utility object for parsing the Houston Ruleset (HRS) language
     * @name HoustonRulesetParser
     * @namespace
     */
    ...
    /*                               *\
    | end HoustonRulesetParser object |
    \*                               */
    ...
    if (
        ...
        // Export the HoustonRulesetParser object.
        exports = module.exports = HoustonRulesetParser;
    }
    // Else, we are in browser land?
    else {
        // Export the HoustonRulesetParser object as a global variable.
        global.HoustonRulesetParser = HoustonRulesetParser;
    }
